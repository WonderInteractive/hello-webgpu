...
#define EM_PTHREADFS_ASM_1(code, arg)                                                                     \
  g_sync_to_async_helper.invoke([&arg](emscripten::sync_to_async::Callback resume) {                   \
    g_resumeFct = [resume]() { (*resume)(); };                                                     \
    EM_ASM({ (async() => { code wasmTable.get($0)(); })(); }, &resumeWrapper_v, arg);                   \
  });
#define EM_PTHREADFS_ASM_2(code, arg1, arg2, arg3)                                                                     \
  g_sync_to_async_helper.invoke([&arg1,&arg2,&arg3](emscripten::sync_to_async::Callback resume) {                   \
    g_resumeFct = [resume]() { (*resume)(); };                                                     \
    EM_ASM({ (async() => { code wasmTable.get($0)(); })(); }, &resumeWrapper_v, arg1, arg2, arg3);                   \
  });
#define EM_PTHREADFS_ASM_3(code, arg1, arg2, arg3)                                                                     \
  g_sync_to_async_helper.invoke([&arg1,&arg2,&arg3](emscripten::sync_to_async::Callback resume) {                   \
    g_resumeFct = [resume]() { (*resume)(); };                                                     \
    EM_ASM({ (async() => { code wasmTable.get($0)(); })(); }, &resumeWrapper_v, arg1, arg2, arg3);                   \
  });
#define EM_PTHREADFS_ASM_4(code, arg1, arg2, arg3, arg4)                                                                     \
  g_sync_to_async_helper.invoke([&arg1,&arg2,&arg3,&arg4](emscripten::sync_to_async::Callback resume) {                   \
    g_resumeFct = [resume]() { (*resume)(); };                                                     \
    EM_ASM({ (async() => { code wasmTable.get($0)(); })(); }, &resumeWrapper_v, arg1, arg2, arg3, arg4);                   \
  });
// clang-format on
